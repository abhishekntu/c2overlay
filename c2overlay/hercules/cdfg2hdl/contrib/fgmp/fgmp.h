...
//typedef char mp_limb;  // NOT WORKING AS PROPER?
...
void mpz_swap PROTO((MP_INT *, MP_INT *));
MP_INT *mpz_max PROTO((MP_INT *, MP_INT *));
MP_INT *mpz_min PROTO((MP_INT *, MP_INT *));
void mpz_printf PROTO((MP_INT *, unsigned long));
void mpz_fprintf PROTO((FILE *, MP_INT *, unsigned long));
void mpz_printd PROTO((MP_INT *));
void mpz_printh PROTO((MP_INT *));
