...
entry  .controls.library      -width 50 -textvariable LIBRARY
entry  .controls.groups       -width 50 -textvariable GROUPS
button .controls.browse       -text "Browse" -command selectIcons
button .controls.view         -text "View"   -command displayIcons
button .controls.exit         -text "Exit"   -command exit

for {set Button 6} {$Button <= 20} {incr Button +2} {
   button .controls.columns.$Button -text "$Button" -width 2 -command "setColumns $Button"
   pack   .controls.columns.$Button -side left
}

.controls.columns.$COLUMNS configure -relief sunken

grid .controls.libraryLabel -row 0 -column 0 -padx 4
...
grid .controls.groupsLabel  -row 2 -column 0 -padx 4
...
grid .controls.columnsLabel -row 4 -column 0 -padx 4
grid .controls.columns      -row 4 -column 1 -pady 2 -sticky ew
